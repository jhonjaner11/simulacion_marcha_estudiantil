...
to setup
  ...
  [set shape "person" set color green set size 1.5 set energy 100 set heading 0
    setxy (random -7) - 58 (random 3) - 1 ;; aqui empiezan los estudiantes
...
to go
  ...
  ask estudiantes [
    if energy > 20
      [ move-to-empty-one-of camino-patches]
...
to setup-patch
set camino-patches patches with [(pycor < 2 and pycor > -2) or (pycor < 11 and pycor > 7) or (pycor < -7 and pycor > -11) or
                                   (pycor < 19  and pycor > 15) or (pycor < -15  and pycor > -19) or

                                   (pxcor < -50 and pxcor > -55) or (pxcor < -25 and pxcor > -30) or
                                   (pxcor < 0 and pxcor > -5) or (pxcor < 25 and pxcor > 20) or (pxcor < 50 and pxcor > 45)
                                   ]
  ask camino-patches [set pcolor white]

  ;;CREATE DESTINO
  set destino-patches patches with [
    ((pycor < 4  and pycor > -4) and (pxcor > 55))] ;; define los patches destino que llegara la marcha
...
to-report direccionfinal [locations]
